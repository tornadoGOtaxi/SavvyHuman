  ...
  return (
    <Layout image="https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&q=80&w=1200&h=1600">
      <div className="space-y-12 pb-20">
        <header>
          <span className="text-indigo-400 font-bold uppercase tracking-[0.6em] text-[10px] block mb-4">OUR STORY</span>
        ...
        <section className="pt-16 border-t border-white/10">
          ...
          <div className="space-y-12">
            <div className="flex gap-8 group">
              <span className="text-indigo-500 font-serif italic text-4xl group-hover:scale-110 transition-transform">01.</span>
              <div className="space-y-2">
                <h4 className="text-white font-bold text-sm uppercase tracking-widest">Results Over Jargon</h4>
            ...
            <div className="flex gap-8 group">
              <span className="text-indigo-500 font-serif italic text-4xl group-hover:scale-110 transition-transform">02.</span>
              <div className="space-y-2">
                <h4 className="text-white font-bold text-sm uppercase tracking-widest">Proactive Optimization</h4>
            ...
            <div className="flex gap-8 group">
              <span className="text-indigo-500 font-serif italic text-4xl group-hover:scale-110 transition-transform">03.</span>
              <div className="space-y-2">
                <h4 className="text-white font-bold text-sm uppercase tracking-widest">Human-Centric Design</h4>
        ...
        <section className="bg-zinc-900 border border-white/5 p-10 rounded-[2.5rem] mt-20">
          <div className="flex flex-col md:flex-row gap-10 items-center">
            ...
            <div className="w-32 h-32 rounded-full bg-indigo-600/20 border border-indigo-500/20 flex items-center justify-center text-indigo-400 font-serif italic text-4xl">
              RI
            </div>
          </div>
        </section>
